...
<pre>export USEOPTIMIZE="yes"</pre>
Set to empty ("") if you don't want to use internal untested optimizations. (Required pthread support)<br>
...
<pre>-f [frequency]</pre>
Specifies what frequency to use in Kilohertz. The CPU runs in real time if no frequency is given. (ONLY IF COMPILED WITH -D R_DEBUG)<br>
<pre>-s</pre>
...
<pre>-fo</pre>
Specifiy a bitmap font in PNG format.<br>
<pre>-fh</pre>
Specify font height<br>
<pre>-fw</pre>
Specify font width<br>
<pre>-fs</pre>
Specify font scale [Floating Point Number]<br>
<pre>-args "arguments"</pre>
Specify program arguments<br>
<pre>-rs scriptname</pre>
Specify R3X configure script. (NOTE: The command line options will be overwritten by the scripts' ones')<br>
</font>
</html>
```
